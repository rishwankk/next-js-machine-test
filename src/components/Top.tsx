...
const Top = () => {
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      {/* Text overlay - responsive positioning and spacing */}
      <div className="absolute inset-0 flex flex-col justify-end px-4 sm:px-6 md:px-8 pb-16 sm:pb-20 md:pb-24 lg:pb-16">
        <div className="text-white max-w-7xl mx-auto w-full text-center">
          ...
          <p className="text-base text-left ml-6 sm:text-lg mb-6 sm:mb-8 md:mb-10 lg:mb-12 w-full sm:w-11/12 md:w-3/4 lg:w-2/3"> {/* Adjusted width for sm screens */}
            {SUBHEADING}
          </p>
        </div>
      </div>
